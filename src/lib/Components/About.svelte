<script>
    ...
    import logo2 from "$lib/assets/logo.png"
</script>
...
<div class="about-container">
    <div class="about pt-sans-regular">
        ...
        <div class="about__two">
            ...
            <h3 class="pt-serif-bold">Open 7 Days a Week</h3>
            <p>The store opens 7 days a week. Check contact / location to see the details.</p>
